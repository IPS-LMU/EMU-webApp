...
describe('Controller: MainCtrl', function () {
    ...
    it('should getBndlColor', function() {
        ...
        var ret = scope.getBndlColor({name: 'ae'});
        expect(ret).toEqual({
    ...
    it('should openDemoDB ae', inject(function ($q) {
        ...
        ioDeferredDBConfig.resolve({data: {EMUwebAppConfig: {}}});
        var ioDeferredBundleList = $q.defer();
        ioDeferredBundleList.resolve({data: ae_bundleList});
    ...
    it('should open download Textgrid', inject(function ($q) {
        ...
        txtgridDeferred.resolve({data: 'test123'}); 
