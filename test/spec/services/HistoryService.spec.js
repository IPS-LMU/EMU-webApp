...
describe('Service: HistoryService', function () {
   ...
   *
   */
  it('should remove object from undo stack by undoing', inject(function (HistoryService) {
    HistoryService.addObjToUndoStack(changeObj);
    HistoryService.undo();
    expect(HistoryService.getCurrentStack().undo.length).toEqual(0);
    expect(HistoryService.getCurrentStack().redo.length).toEqual(1);
    expect(Object.keys(HistoryService.getCurrentStack().redo[0])[0]).toEqual('ESPS#renameLabel#Phonetic#12');
  }));  

  /**
   *
   */
  it('should add object again to undo stack by undoing / redoing', inject(function (HistoryService) {
    HistoryService.addObjToUndoStack(changeObj);
    HistoryService.undo();
    HistoryService.redo();
    expect(HistoryService.getCurrentStack().undo.length).toEqual(1);
   ...
   *
   */
  it('should remove object again from undo stack by undoing / redoing / undoing', inject(function (HistoryService) {
    HistoryService.addObjToUndoStack(changeObj);
    HistoryService.undo();
    HistoryService.redo();
    HistoryService.undo();
   ...
   *
   */
  it('should undo and redo 2 steps', inject(function (HistoryService) {
    HistoryService.addObjToUndoStack(changeObj);
    HistoryService.addObjToUndoStack(changeObj);
    HistoryService.undo();
    HistoryService.undo();
    ...
    expect(HistoryService.getCurrentStack().redo.length).toEqual(0);
    expect(Object.keys(HistoryService.getCurrentStack().undo[0])[0]).toEqual('ESPS#renameLabel#Phonetic#12');
    expect(Object.keys(HistoryService.getCurrentStack().undo[1])[0]).toEqual('ESPS#renameLabel#Phonetic#12');
  }));  
