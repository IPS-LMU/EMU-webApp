...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2.8cm,
  ...
  \node[state, fill=grey!20]         (L) [right of=J] {12};
  \node[state, fill=grey!20]         (M) [right of=L] {13};
  \node[state, fill=grey!20]         (N) [right of=M] {14};

  \node[state, fill=grey!20]         (O) [right of=K] {15};
  \node[state, fill=grey!20]         (P) [right of=O] {16};
  \node[state, fill=grey!20]         (Q) [right of=P] {17};
  \node[state, fill=grey!20]         (R) [right of=Q] {18};
